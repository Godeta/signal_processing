...
chdir(PATH)
getd('lib');
listPeakText = 'none|find_extremum|peakfinder';
listFilteringText = 'none|convolution ';
//GUI_SHOW();
...
function listPeaks_callback(handles)
    ...
    if (choice >1) then
      ...
      for i=1:5 //for as many data files as we have
        ...
        [nbBouteille1, nbBouteilleRef1] = count_peaks(proto(:,1),proto(:,2),-1,choice, get(handles.checkPlot,"value"));
        [nbBouteille2, nbBouteilleRef2] = count_peaks(ref(:,1),ref(:,2),ref(:,3),choice, get(handles.checkPlot,"value"));
